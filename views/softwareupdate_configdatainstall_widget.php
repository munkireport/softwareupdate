<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="su_configdatainstall-widget">
        <div id="su_configdatainstall-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-shield"></i> 
                <span data-i18n="softwareupdate.configdatainstall_widget"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/softwareupdate/get_configdatainstall', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#su_configdatainstall-widget div.panel-body'),
