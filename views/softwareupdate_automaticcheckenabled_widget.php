<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="su_automaticcheckenabled-widget">
        <div id="su_automaticcheckenabled-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-check-square"></i> 
                <span data-i18n="softwareupdate.automaticcheckenabled_widget"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/softwareupdate/get_automaticcheckenabled', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#su_automaticcheckenabled-widget div.panel-body'),
