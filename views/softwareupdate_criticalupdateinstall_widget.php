<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="su_criticalupdateinstall-widget">
        <div id="su_criticalupdateinstall-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-exclamation-triangle"></i> 
                <span data-i18n="softwareupdate.criticalupdateinstall_widget"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/softwareupdate/get_criticalupdateinstall', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#su_criticalupdateinstall-widget div.panel-body'),
