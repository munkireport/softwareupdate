<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="su_automaticdownload-widget">
        <div id="su_automaticdownload-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-download"></i> 
                <span data-i18n="softwareupdate.automaticdownload_widget"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/softwareupdate/get_automaticdownload', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#su_automaticdownload-widget div.panel-body'),
