<div class="col-lg-4 col-md-6">
    <div class="panel panel-default" id="su_auto_update_restart_required-widget">
        <div id="su_auto_update_restart_required-widget" class="panel-heading" data-container="body">
            <h3 class="panel-title"><i class="fa fa-refresh"></i> 
                <span data-i18n="softwareupdate.auto_update_restart_required_widget"></span>
...
$(document).on('appUpdate', function(e, lang) {
    ...
    $.getJSON( appUrl + '/module/softwareupdate/get_auto_update_restart_required', function( data ) {
        if(data.error){
            //alert(data.error);
            return;
        }

        var panel = $('#su_auto_update_restart_required-widget div.panel-body'),
